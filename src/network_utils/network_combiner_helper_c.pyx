"""This script's intention is to speed up the random attachment and small-world attachment
by making use of the cython library. Heavy loops are translated into c to optimize the algorithm.
